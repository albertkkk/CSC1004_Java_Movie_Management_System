            ...
            <form id="form2"
                ...
                <div class="pad input-container">
                    <section class="content">
                        ...
                        <span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-gender"
                                       placeholder="请输入性别" maxlength="15" name="gender"/>
								<label class="input__label input__label--hideo" for="register-gender">
									<i class="fa fa-fw fa-lock icon icon--hideo"></i>
									<span class="input__label-content input__label-content--hideo"></span>
								</label>
							</span>
                        <span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-address"
                                       placeholder="请输入地址" maxlength="30" name="address"/>
								<label class="input__label input__label--hideo" for="register-address">
									<i class="fa fa-fw fa-lock icon icon--hideo"></i>
									<span class="input__label-content input__label-content--hideo"></span>
								</label>
							</span>
